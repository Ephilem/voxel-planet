...
namespace vp {
    ...
    public:
        explicit PlanetTileGenerator(PlanetTerrainParams params, uint16_t resolution,
                                     double planetRadius, unsigned workerCount = 0);
        ~PlanetTileGenerator();
    ...
    private:
        ...
        void generate(const PlanetTileKey &key, PlanetTileData &out, const PlanetTerrainSampler &sampler, PlanetTerrainSampler::BatchScratch &scratch) const;
